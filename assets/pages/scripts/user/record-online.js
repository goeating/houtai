$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./record-online.json" // ajax source
            },
            "order": [
                [1, 'asc']
            ],// 表格在初始化的时候的排序
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        console.log(data);
                        return data === 0 ? '<span class="label label-sm label-danger"> 未付款 </span>' : '<span class="label label-sm label-success"> 已付款 </span>';
                    }
                },
                {
                    "targets": 13,
                    "render": function (data, type, full, meta) {
                        return data === 0 ? '<span class="label label-sm label-danger"> 未完成 </span>' : '<span class="label label-sm label-success"> 已完成 </span>';
                    }
                }
            ],
            "columns": [
