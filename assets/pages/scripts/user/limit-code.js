        ...
        dataTable: {
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return function () {
                            switch (data) {
                                case 0:
                                    return '<span class="label label-sm label-success"> 未限制 </span>';
                                    break;
                                case 1:
                                    return '<span class="label label-sm label-danger"> 限制 </span>';
                                    break;
                            }
                        };
                    }
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full, meta) {
                        return '<a class="btn btn-sm green btn-outline" href="./limit-code-editor.html"> 修改 </a><a class="btn btn-sm green btn-outline delete" href="javascript:;"> 删除 </a>';
                    }
                }
