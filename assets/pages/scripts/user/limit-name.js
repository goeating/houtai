$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./limit-name.json" // ajax source
            },
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        console.log(full);
                        return '<a class="btn btn-sm green btn-outline" href="./limit-name-editor.html"> 修改 </a> <a class="btn btn-sm green btn-outline delete" href="javascript:;"> 删除 </a>';
                    }
                }
