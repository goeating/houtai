$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./management-role.json" // ajax source
            },
            "order": [],// 表格在初始化的时候的排序
            "columnDefs": [
                {
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full, meta) {
                        return '<a class="btn btn-sm green btn-outline updata" href="./management-role-editor.html"> 更新 </a><a class="btn btn-sm green btn-outline config" href="./management-role-config.html"> 配置权限 </a>';
                    }
                }
            ],
            "columns": [
