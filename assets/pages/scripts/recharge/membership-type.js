$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./membership-type.json" // ajax source
            },
            "order": [
                [1, 'asc']
            ],// 表格在初始化的时候的排序
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return function () {
                            ...
                            {
                                case "blue":
                                    return '<span class="label label-sm label-info"> 蓝钻 </span>';
                                    break;
                                case "yellow":
                                    return '<span class="label label-sm label-warning"> 黄钻 </span>';
                                    break;
                                case "light":
                                    return '<span class="label label-sm label-success"> 白钻 </span>';
                                    break;
                                case "red":
                                    return '<span class="label label-sm label-danger"> 红钻 </span>';
                                    break;
                            }
                        };
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full, meta) {
                        return '<a class="btn btn-sm green btn-outline" href="./membership-type-editor.html"> 更新 </a>';
                    }
                }
            ],
            "columns": [
