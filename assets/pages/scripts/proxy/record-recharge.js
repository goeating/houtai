$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./record-recharge.json" // ajax source
            },
            "order": [
                [0, 'asc']
            ],// 表格在初始化的时候的排序
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return function () {
                            switch (data) {
                                case 0:
                                    return '<span class="label label-sm label-danger"> 未支付 </span>';
                                    break;
                                case 1:
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return function () {
                            switch (data) {
                                case 0:
                                    return '<span class="label label-sm label-danger"> 未完成 </span>';
                                    break;
                                case 1:
            ...
            "columns": [
                ...
                {"data": "actualPayment"},
                {"data": "orderNumber"},
                {"data": "paymentPlatformOrderNumber"},
                {"data": "paymentType"},
