$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./management-proxy.json" // ajax source
            },
            "order": [
                [3, 'asc']
            ],// 表格在初始化的时候的排序
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        return  function () {
                            switch (data) {
                                case 0:
                                    return '<label class="mt-checkbox mt-checkbox-outline"> 不允许登录 <input type="checkbox" value="1" name="test"><span></span></label>';
                                    break;
                                case 1:
                                    return '<label class="mt-checkbox mt-checkbox-outline"> 允许登录 <input type="checkbox" value="1" name="test" checked="checked"><span></span></label>';
                                    break;
                            }
                        };
                    }
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full, meta) {
                        return '<a class="btn btn-sm green btn-outline updata" href="./management-proxy-editor.html"> 更新 </a><a class="btn btn-sm green btn-outline delete" href="javascript:;"> 删除 </a>';
                    }
                }
