$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./integral-mall.json" // ajax source
            },
            "order": [
                [1, 'asc']
            ],// 表格在初始化的时候的排序
            "columnDefs": [
                ...
                },
                {
                    "targets": 12,
                    "render": function (data, type, full, meta) {
                        return data === true ? '<label class="mt-checkbox mt-checkbox-outline"> 上架 <input type="checkbox" value="1" name="test" checked="checked"><span></span></label>' : '<label class="mt-checkbox mt-checkbox-outline"> 下架 <input type="checkbox" value="1" name="test"><span></span></label>';
                    }
                },
                {
                    "targets": 13,
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full, meta) {
                        return '<a class="btn btn-sm green btn-outline" href="./integral-mall-editor.html"> 修改 </a><a class="btn btn-sm green btn-outline delete" href="javascript:;"> 删除 </a>';
                    }
                }
            ],
            "columns": [
