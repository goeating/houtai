$(function () {
    ...
    grid.init({
        ...
        dataTable: {
            ...
            "ajax": {
                "url": "./management-merchant.json" // ajax source
            },
            "order": [
                [2, 'asc']
            ],// 表格在初始化的时候的排序
            "columnDefs": [
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function (data, type, full, meta) {
                        return '<a class="btn btn-sm green btn-outline" href="./management-merchant-editor.html"> 详细 </a><a class="btn btn-sm green btn-outline delete" href="javascript:;"> 删除 </a>';
                    }
                }
            ],
            "columns": [
